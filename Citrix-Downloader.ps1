...
$WebResponseVersion = Invoke-WebRequest -UseBasicParsing "https://raw.githubusercontent.com/skippy1471/Citrix/main/Citrix-Downloader.ps1"
If (!$WebVersion) {
...
If (!(Test-Path -Path "$env:USERPROFILE\Desktop\Citrix Downloader.lnk")) {
    ...
    If (!(Test-Path -Path "$PSScriptRoot\shortcut\CitrixDownloaderLogo.ico")) {Invoke-WebRequest -Uri https://raw.githubusercontent.com/skippy1471/Citrix/main/shortcut/CitrixDownloaderLogo.ico -OutFile ("$PSScriptRoot\shortcut\" + "CitrixDownloaderLogo.ico")}
...
If (!(Test-Path -Path "$PSScriptRoot\img\CitrixDownloaderLogo.png")) {
    ...
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/skippy1471/Citrix/main/img/CitrixDownloaderLogo.png -OutFile ("$PSScriptRoot\img\" + "CitrixDownloaderLogo.png")
}
    ...
    Else {
        ...
        If ($file) {
            $update = @'
                ...
                Invoke-WebRequest -Uri https://raw.githubusercontent.com/skippy1471/Citrix/main/Citrix-Downloader.ps1 -OutFile ("$PSScriptRoot\" + "Citrix-Downloader.ps1")
